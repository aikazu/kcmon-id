...
const Section = ({ section, sectionIndex, className = "mb-14" }) => {
...
const ProfileHeader = ({ className = "mb-20" }) => (
...
const ProfileFooter = ({ className = "mt-24" }) => (
  <footer
...
export default function App() {
  ...
  const getSectionIndex = (title) => sections.findIndex(s => s.title === title);
